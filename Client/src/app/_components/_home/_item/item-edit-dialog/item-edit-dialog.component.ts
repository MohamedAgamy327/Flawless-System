...
export class ItemEditDialogComponent {
  ...
  constructor(private formBuilder: FormBuilder, private dialogRef: MatDialogRef<ItemEditDialogComponent>,
  ...
  update() {
    this.repository.put('items', this.editForm.value).subscribe(
      (res: any) => {
